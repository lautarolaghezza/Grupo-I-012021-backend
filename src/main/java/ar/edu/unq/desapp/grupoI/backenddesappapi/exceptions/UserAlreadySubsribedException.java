...
public class UserAlreadySubsribedException extends ResponseStatusException {

    static String reason = "User already subscribe to tittle";
    public UserAlreadySubsribedException(HttpStatus status) {
        super(status, reason);
